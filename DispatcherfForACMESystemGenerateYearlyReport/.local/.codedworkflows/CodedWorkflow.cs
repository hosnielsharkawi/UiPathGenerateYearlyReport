...
namespace DispatcherfForACMESystemGenerateYearlyReport
{
    ...
    {
        private Lazy<global::DispatcherfForACMESystemGenerateYearlyReport.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::DispatcherfForACMESystemGenerateYearlyReport.WorkflowRunnerService>(() => new global::DispatcherfForACMESystemGenerateYearlyReport.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::DispatcherfForACMESystemGenerateYearlyReport.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
