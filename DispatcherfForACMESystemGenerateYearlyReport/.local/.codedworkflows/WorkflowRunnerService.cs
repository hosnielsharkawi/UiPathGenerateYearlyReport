...
using DispatcherfForACMESystemGenerateYearlyReport;

[assembly: WorkflowRunnerServiceAttribute(typeof(DispatcherfForACMESystemGenerateYearlyReport.WorkflowRunnerService))]
namespace DispatcherfForACMESystemGenerateYearlyReport
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the ACMESystem/CloseBrowser.xaml
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void CloseBrowser(System.Collections.Generic.Dictionary<string, object> in_Config, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\CloseBrowser.xaml", new Dictionary<string, object> { { "in_Config", in_Config } }, default, isolated, default, GetAssemblyName());
        }

        /// <summary>
        /// Invokes the ACMESystem/CloseBrowser.xaml
        /// </summary>
        public void CloseBrowser(System.Collections.Generic.Dictionary<string, object> in_Config)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\CloseBrowser.xaml", new Dictionary<string, object> { { "in_Config", in_Config } }, default, default, default, GetAssemblyName());
        }

        /// <summary>
        /// Invokes the ACMESystem/ExtractClientInfoData.xaml
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void ExtractClientInfoData(System.Collections.Generic.Dictionary<string, object> in_Config, System.Data.DataTable in_dtWorkItemFilterd, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\ExtractClientInfoData.xaml", new Dictionary<string, object> { { "in_Config", in_Config }, { "in_dtWorkItemFilterd", in_dtWorkItemFilterd } }, default, isolated, default, GetAssemblyName());
        }

        /// <summary>
        /// Invokes the ACMESystem/ExtractClientInfoData.xaml
        /// </summary>
        public void ExtractClientInfoData(System.Collections.Generic.Dictionary<string, object> in_Config, System.Data.DataTable in_dtWorkItemFilterd)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\ExtractClientInfoData.xaml", new Dictionary<string, object> { { "in_Config", in_Config }, { "in_dtWorkItemFilterd", in_dtWorkItemFilterd } }, default, default, default, GetAssemblyName());
        }

        /// <summary>
        /// Invokes the ACMESystem/ExtractWorkItemsTable.xaml
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public System.Data.DataTable ExtractWorkItemsTable(System.Collections.Generic.Dictionary<string, object> in_Config, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\ExtractWorkItemsTable.xaml", new Dictionary<string, object> { { "in_Config", in_Config } }, default, isolated, default, GetAssemblyName());
            return (System.Data.DataTable)result["out_dtWorkItemFilterd"];
        }

        /// <summary>
        /// Invokes the ACMESystem/ExtractWorkItemsTable.xaml
        /// </summary>
        public System.Data.DataTable ExtractWorkItemsTable(System.Collections.Generic.Dictionary<string, object> in_Config)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\ExtractWorkItemsTable.xaml", new Dictionary<string, object> { { "in_Config", in_Config } }, default, default, default, GetAssemblyName());
            return (System.Data.DataTable)result["out_dtWorkItemFilterd"];
        }
        ...
        /// <summary>
        /// Invokes the ACMESystem/RegexForClientData.cs
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public (System.String ClientTaxID, System.String ClientName, System.String ClientAddress, System.String ClientCity) RegexForClientData(System.String clientInfoText, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\RegexForClientData.cs", new Dictionary<string, object> { { "clientInfoText", clientInfoText } }, default, isolated, default, GetAssemblyName());
            return ((System.String)result["ClientTaxID"], (System.String)result["ClientName"], (System.String)result["ClientAddress"], (System.String)result["ClientCity"]);
        }

        /// <summary>
        /// Invokes the ACMESystem/RegexForClientData.cs
        /// </summary>
        public (System.String ClientTaxID, System.String ClientName, System.String ClientAddress, System.String ClientCity) RegexForClientData(System.String clientInfoText)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"ACMESystem\RegexForClientData.cs", new Dictionary<string, object> { { "clientInfoText", clientInfoText } }, default, default, default, GetAssemblyName());
            return ((System.String)result["ClientTaxID"], (System.String)result["ClientName"], (System.String)result["ClientAddress"], (System.String)result["ClientCity"]);
        }
