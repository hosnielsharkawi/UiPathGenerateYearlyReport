...
namespace PerformerfForACMESystemGenerateYearlyReport
{
    ...
    {
        private Lazy<global::PerformerfForACMESystemGenerateYearlyReport.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::PerformerfForACMESystemGenerateYearlyReport.WorkflowRunnerService>(() => new global::PerformerfForACMESystemGenerateYearlyReport.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::PerformerfForACMESystemGenerateYearlyReport.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
